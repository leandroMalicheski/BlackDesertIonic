...
export class HomePage {
  ...
  createFoods(){
    ...
    let beer = new Food ("0","Cerveja","Iniciante 1","assets/img/foodAndIgredients/beer.png",[{"name":"Cerveja Gelada"}],beerIngredients, true);
    ...
    let boiledEgg = new Food ("2","Ovos de Pássaro Cozido", "Iniciante 6", "assets/img/foodAndIgredients/boiledEgg.png", [{"name":"Ovo Cozido Atraente"}], boiledEggIngredients,true);
    let oatmeal = new Food("3","Aveia","Aprendiz 1","assets/img/foodAndIgredients/oatmealA.png", [{"name":"Aveia Refinada"}], oatmealIngredients, true);
    let friedFish = new Food ("4","Peixe Frito","Iniciante 1", "assets/img/foodAndIgredients/friedFish.png", [{"name":"Peixe Frito Crocante"}], friedFishIngredients,true);
    let fishFilletChips = new Food ("5", "Salgado de File de Peixe", "Aprendiz 1", "assets/img/foodAndIgredients/fishFilletChips.png", [{"name":"Salgado de File de Peixe Delicioso"}], fishFilletChipsIngredients, true);
    let meatStew = new Food("6","Ensopado de Carne","Iniciante 6", "assets/img/foodAndIgredients/meatStew.png", [{"name":"Ensopado de Carne Forte"}], meatStewIngredients, true);
    let omelete = new Food ("7","Omelete","Aprendiz 1","assets/img/foodAndIgredients/omelete.png", [{"name":"Omelete Macio"}], omeleteIngredients, true);
    let honeycombCookie = new Food("8", "Biscoito de Mel", "Aprendiz 6", "assets/img/foodAndIgredients/honeycombCookie.png", [{"name":"Biscoito de Mel Crocante"}], honeycombCookieIngredients, true);
    let teaWithFineScent = new Food("9", "Chá com Aroma Fino", "Aprendiz 1", "assets/img/foodAndIgredients/teaWithFineScent.png", [{"name":"Chá com Aroma Fino Forte"}], teaWithFineScentIngredients, true);
    let steak = new Food("10","Bife","Aprendiz 1", "assets/img/foodAndIgredients/steak.png", [{"name":"Bife Suculento"}], steakIngredientList, true);
    let fruitPudding = new Food("11","Pudim de Frutas", "Iniciante 6", "assets/img/foodAndIgredients/fruitPudding.png", [{"name":"Pudim de Frutas Especial"}], fruitPuddingIngredientList, true);
    let softBread = new Food("12","Pão Macio","Iniciante 6", "assets/img/foodAndIgredients/softBread.png", [{"name":"Pão de Leite Úmido"}],softBreadIngredientList,true);
    let meatPie = new Food("13","Torta de Carne","Aprendiz 1", "assets/img/foodAndIgredients/meatPie.png", [{"name":"Torta de Carne Deliciosa"}], meatPieIngredients, true);
